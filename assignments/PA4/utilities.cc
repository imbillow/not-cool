...
void
print_escaped_string(ostream& str, const char* s)
{
  while (*s) {
    switch (*s) {
      case '\\':
...
void
dump_cool_token(ostream& out, int lineno, int token, YYSTYPE yylval)
{
