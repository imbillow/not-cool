...
void
dump_Symbol(ostream& stream, int padding, Symbol b);

// defined in cool.h
void
dump_Boolean(ostream& stream, int padding, Boolean b);
...
void
Expression_class::dump_type(ostream& stream, int n)
{
  if (type) {
...
void
dump_line(ostream& stream, int n, tree_node* t)
{
...
//
void
program_class::dump_with_types(ostream& stream, int n)
{
...
//
void
class__class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_class\n";
...
void
method_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
...
//
void
attr_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_attr\n";
  dump_Symbol(stream, n + 2, name);
...
//
void
formal_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
...
//
void
branch_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
...
//
void
assign_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
...
//
void
static_dispatch_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
...
//
void
dispatch_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
...
//
void
cond_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_cond\n";
...
//
void
loop_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_loop\n";
  pred->dump_with_types(stream, n + 2);
...
//
void
typcase_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
...
//
void
block_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_block\n";
...
void
let_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_let\n";
...
void
plus_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_plus\n";
...
void
sub_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_sub\n";
  e1->dump_with_types(stream, n + 2);
...
void
mul_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_mul\n";
  e1->dump_with_types(stream, n + 2);
...
void
divide_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
...
void
neg_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_neg\n";
  e1->dump_with_types(stream, n + 2);
...
void
lt_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_lt\n";
  e1->dump_with_types(stream, n + 2);
...
void
eq_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_eq\n";
  e1->dump_with_types(stream, n + 2);
...
void
leq_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_leq\n";
  e1->dump_with_types(stream, n + 2);
...
void
comp_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_comp\n";
  e1->dump_with_types(stream, n + 2);
...
void
int_const_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_int\n";
...
void
bool_const_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_bool\n";
...
void
string_const_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
...
void
new__class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
  stream << pad(n) << "_new\n";
  dump_Symbol(stream, n + 2, type_name);
...
void
isvoid_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
...
void
no_expr_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
...
void
object_class::dump_with_types(ostream& stream, int n)
{
  dump_line(stream, n, this);
